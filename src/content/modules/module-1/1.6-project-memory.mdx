...
module: 1
lesson: 6
description: "Use CLAUDE.md project memory to store your brand voice, client context, and audience profiles so Claude Code applies them consistently across every marketing task."
duration: "20 min"
objectives:
