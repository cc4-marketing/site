...
module: 1
lesson: 2
description: "Learn to find, read, write, and organize marketing files in Claude Code — folder conventions, fast file search, and the commands you will use on every project."
duration: "25 min"
objectives:
