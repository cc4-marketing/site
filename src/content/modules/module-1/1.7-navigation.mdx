...
module: 1
lesson: 7
description: "Master Claude Code navigation: quick file finding, cross-project search, folder management, and organization techniques that speed up every marketing workflow."
duration: "20 min"
objectives:
