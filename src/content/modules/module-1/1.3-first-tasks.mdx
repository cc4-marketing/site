...
module: 1
lesson: 3
description: "Complete your first real marketing tasks: generate multi-channel copy, run a competitive analysis, and draft a content strategy — all inside Claude Code."
duration: "30 min"
objectives:
