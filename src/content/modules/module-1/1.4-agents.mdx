...
module: 1
lesson: 4
description: "Understand what Claude Code agents are and when to use them for parallel marketing workflows, multi-perspective feedback, and complex campaign coordination."
duration: "35 min"
objectives:
