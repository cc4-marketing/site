...
> **Wrong lesson if your list is bigger than ~50, or you actually want merge tags.** Sigil is built for VIP-size sends where a handcrafted sentence per recipient is worth the time. If you're sending a segmented campaign to hundreds of contacts with structured personalization (name, company, account owner) instead of handcrafted prose, [Lesson 3.1](/modules/3/merge-campaigns-safely/) covers that case — plus the send-safety and personalization-ethics discipline this lesson assumes you already have.
